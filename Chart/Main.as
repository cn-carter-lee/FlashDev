...
package  {
	...
	public class Main extends Sprite {
		...
		private function parse_json( json_string:String ):void {
			...
			try {
				// ExFlash 9.0  var json:Object = JSON.deserialize( json_string );
				var json:Object = JSON.parse( json_string,null );  // Flash 11.9
				ok = true;
			}
			catch (e:Error) {
				// remove the 'loading data...' msg:
		...
		private function build_chart( json:Object ):void {
			...
			//tr.ace('----');
			// ExFlash 9.0 tr.ace(JSON.serialize(json));
