package elements.labels
{
	...
	public class XLegend extends BaseLabel
	{
		...
		public function resize(sc:ScreenCoords):void
		{
			...
			// this will center it in the X this will align bottom:
		...
		// this is only here while title has CSS and x legend does not.remove this when we put css in this object
