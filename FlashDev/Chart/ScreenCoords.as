package
{
	...
	public class ScreenCoords extends ScreenCoordsBase
	{
		...
		public function ScreenCoords(top:Number, left:Number, right:Number, bottom:Number, y_axis_range:Range, y_axis_right_range:Range, x_axis_range:Range, x_left_label_width:Number, x_right_label_width:Number, three_d:Boolean)
		{
		...
		public override function get_get_x_from_pos_and_y_from_val(index:Number, y:Number, right_axis:Boolean = false):flash.geom.Point
		{
			...
			return new flash.geom.Point(this.get_x_from_pos(index), this.get_y_from_val(y, right_axis));
		}
...
//			var item_width:Number = Math.abs(this.width_() / this.x_range.count());
		...
		public function makePointHLC(x:Number, high:Number, close:Number, low:Number, right_axis:Boolean, group:Number, group_count:Number):PointHLC
		{
			...
			return new PointHLC(left, this.get_y_from_val(high, right_axis), this.get_y_from_val(close, right_axis), this.get_y_from_val(low, right_axis), high, bar_width
//				,close
				);
