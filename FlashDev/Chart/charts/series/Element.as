package charts.series
{
	...
	public class Element extends Sprite implements has_tooltip
	{
		...
		{
			// elements don't change shape much, so lets cache it			
		...
		protected function attach_events():void
		{
			...
			this.addEventListener(MouseEvent.CLICK, this.mouseClick, false, 0, true);
		}
		...
		{
			this.dispatchEvent(new ChartSetSelectEvent(ChartSetSelectEvent.SELECTED, ChartNavType.Undefined, this._x));
		}
