(
    function ($) {
        ...
        var aMonths = ['Jan', 'Feb', '1Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
        ...
        jqTimeLine.prototype._generateMarkup = function () {
            ...
            $mainContainer.append('<div class="horizontal-line month-line even-month" style="left:94px"><div class="month">03/28</div></div>');
        ...
        jqTimeLine.prototype._getMonthMarkup = function (num, year) {
            ...
            var resultString = "";
            if (num == 0) {
                resultString = '<div class="horizontal-line leftend" style="left:' + _this._current_offset_x + 'px">' +
						'<div class="year">' + year + '</div>' +
						'<div class="month">Jan</div>' +
					'</div>';
            } else if (num % 2 == 1) {
                resultString = '<div class="horizontal-line month-line odd-month" style="left:' + _this._current_offset_x + 'px"></div>';
            } else {
                resultString = '<div class="horizontal-line month-line even-month" style="left:' + _this._current_offset_x + 'px"><div class="month">' + aMonths[num] + '</div></div>';
            }
